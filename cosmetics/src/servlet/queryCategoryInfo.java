...
//		out.println(key);
        ...
        result.addProperty("mallId", 449142915);
...
//				System.out.println(catInfo3base);
	...
	public static String getCategoryInfo(String catId) {
		...
		if(catId==null) {
			postdata="{\"mallId\":"+queryGoodsRank.getcookie("mallId")+",\"cat1Id\":18482,\"crawlerInfo\":\""+key+"\"}";
		}else {
			postdata="{\"mallId\":"+queryGoodsRank.getcookie("mallId")+",\"cat1Id\":18482,\"cat2Id\":"+catId+",\"crawlerInfo\":\""+key+"\"}";
		}

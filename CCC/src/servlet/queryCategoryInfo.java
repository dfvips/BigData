...
//		out.println(key);
        ...
        result.addProperty("mallId", queryGoodsRank.getcookie("mallId"));
...
//				System.out.println(catInfo3base);
	...
	public static String getCategoryInfo(String catId) {
		...
		if(catId==null) {
			postdata="{\"mallId\":"+queryGoodsRank.getcookie("mallId")+",\"cat1Id\":2933,\"crawlerInfo\":\""+key+"\"}";
		}else {
			postdata="{\"mallId\":"+queryGoodsRank.getcookie("mallId")+",\"cat1Id\":2933,\"cat2Id\":"+catId+",\"crawlerInfo\":\""+key+"\"}";
		}

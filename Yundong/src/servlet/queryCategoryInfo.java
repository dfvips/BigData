...
//				System.out.println(catInfo3base);
	...
	public static String getCategoryInfo(String catId) {
		...
		if(catId==null) {
			postdata="{\"mallId\":"+queryGoodsRank.getcookie("mallId")+",\"cat1Id\":18637,\"crawlerInfo\":\""+key+"\"}";
		}else {
			postdata="{\"mallId\":"+queryGoodsRank.getcookie("mallId")+",\"cat1Id\":18637,\"cat2Id\":"+catId+",\"crawlerInfo\":\""+key+"\"}";
		}

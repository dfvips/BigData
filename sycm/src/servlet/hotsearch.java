...
public class hotsearch extends HttpServlet {
	...
	public static String api(String date,Integer catId,Integer parentId) {
		String api = "https://sycm.taobao.com/mc/v2/mq/mkt/rank/item/hotsearch.json?dateRange="+date+"%7C"+date+"&dateType=day&pageSize=10&page=1&order=desc&orderBy=uvIndex&cateId="+catId+"&device=0&sellerType=-1&styleId=&priceSeg=&pageId=&indexCode=uvIndex%2CseIpvUvHits%2CtradeIndex&_="+new Date().getTime()+"&token="+getCookie.getcookie("token");

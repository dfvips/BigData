...
public class getHotlist extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<goods> list = service.service.searchHotlist(catID, dateRange);
		...
		for (int i = 0; i < list.size(); i++) {
			...
			String date = goods.getupdate_date();
			Integer visitorNum = goods.getvisitor_num();
			String goodsName = goods.getgoods_name();
			Integer orderNum = goods.getorder_num();
			String incrPercent = goods.getincr_percent();
